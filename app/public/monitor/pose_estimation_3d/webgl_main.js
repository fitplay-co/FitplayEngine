...
render_skelton_3d (gl, landmarks)
{
    ...
    for (let is_shadow = 1; is_shadow >= 0; is_shadow --)
    {
        ...
        for (let i = 0; i < kPoseKeyNum ; i ++)
        {
            ...
            if (!is_shadow)
            {
                if      (i >= 33) colj = col_blue;  
                else if (i >= 27) colj = col_cyan;
                else if (i >=  27) colj = col_green;
                else if (i >=  23) colj = col_violet;
                else if (i >=  11) colj = col_red;
                else              colj = col_yellow;
            }

            const rad = (i < 33) ? s_gui_prop.joint_radius : s_gui_prop.joint_radius / 3;
            const alp = colj[3];

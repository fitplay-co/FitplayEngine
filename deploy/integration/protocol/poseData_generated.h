...
struct Pose FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool rgbdEnabled() const {
    return GetField<uint8_t>(VT_RGBDENABLED, 0) != 0;
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_RGBDENABLED, 1) &&
...
struct PoseBuilder {
  ...
  void add_rgbdEnabled(bool rgbdEnabled) {
    fbb_.AddElement<uint8_t>(Pose::VT_RGBDENABLED, static_cast<uint8_t>(rgbdEnabled), 0);
  }
...
inline flatbuffers::Offset<Pose> CreatePose(
  ...
  builder_.add_rgbdEnabled(rgbdEnabled);

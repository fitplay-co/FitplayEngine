...
function DisplayData(data) {
  ...
  if(jsonObj.sensor_type=="imu")
  {
    ...
    if(deviceId==jsonObj.device_id)
    {
      ...
      mag_x.value=jsonObj.imu.magnetometer.x.toFixed(6);;
      mag_y.value=jsonObj.imu.magnetometer.y.toFixed(6);;
      mag_z.value=jsonObj.imu.magnetometer.z.toFixed(6);;
    ...
    else if(deviceId2==jsonObj.device_id)
    {
      ...
      mag_x2.value=jsonObj.imu.magnetometer.x.toFixed(6);
      mag_y2.value=jsonObj.imu.magnetometer.y.toFixed(6);
      mag_z2.value=jsonObj.imu.magnetometer.z.toFixed(6);

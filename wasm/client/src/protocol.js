   ...
   this.parse=(uint8buff,buflen,callback)=>{
       ...
       // console.log("this.uint8buff",this.uint8buff);
        ...
        if(cmd==CMD_INPUT)
        {
          ...
          jsOjbImu.imu.magnetometer.x=(dataview.getUint16(25,true)-32768)/1024;
          jsOjbImu.imu.magnetometer.y=(dataview.getUint16(27,true)-32768)/1024;
          jsOjbImu.imu.magnetometer.z=(dataview.getUint16(29,true)-32768)/1024; 

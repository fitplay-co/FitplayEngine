...
static finishWalkBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset);
}

static finishSizePrefixedWalkBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {

...
var point_1 = require("../pose-data/point");
var Pose = /** @class */ (function () {
    ...
    Pose.prototype.action = function (optionalEncoding) {
    ...
    Pose.addAction = function (builder, actionOffset) {
    ...
    Pose.createPose = function (builder, actionOffset, keypointsOffset, keypoints3DOffset) {
